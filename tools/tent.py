...
def parse_args():
    ...
    # parser.add_argument('--config', default='local_configs/segformer/B5/segformer.b5.1024x1024.city.160k_foggy.py', help='test config file path')
    # parser.add_argument('--checkpoint', default='segformer.b5.1024x1024.city.160k.pth', help='checkpoint file')
    parser.add_argument('--config', default = "local_configs/segformer/B5/segformer.b5.1024x1024.acdc.160k.py", help='test config file path')
    # parser.add_argument('--checkpoint', default ="finetune_dir/latest.pth", help='checkpoint file')
    parser.add_argument('--checkpoint', default ="segformer.b5.1024x1024.city.160k.pth", help='checkpoint file')
    ...
    for i in range(10):
        ...
        for dataset, data_loader in zip(datasets, data_loaders):
            ...
            if rank == 0:
                ...
                if args.eval:
                    result = dataset.evaluate(outputs, args.eval, **kwargs)
        del data_loaders
