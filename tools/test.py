...
def parse_args():
    ...
    parser.add_argument('--config', default='local_configs/segformer/B5/segformer.b5.1024x1024.city.160k_foggy_none.py', help='test config file path')
    ...
    parser.add_argument('--num_img', type=int, default=1000)
